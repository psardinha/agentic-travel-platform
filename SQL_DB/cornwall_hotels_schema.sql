...
CREATE TABLE IF NOT EXISTS hotel_room_offers (
    ...
    available_single_rooms INTEGER NOT NULL,
    price_single REAL NOT NULL,
    available_double_rooms INTEGER NOT NULL,
...
('St Ives Bay Resort Superb', 'St Ives', '9.A Bay Rd, St Ives', 4.99, 'Resort with great great bay views.'),
('St Ives Bay Resort Stinky', 'St Ives', '9.B Bay Rd, St Ives', 4.1, 'Resort with no views.');

-- Pre-populate hotel room offers
INSERT INTO hotel_room_offers (hotel_id, available_single_rooms, price_single, available_double_rooms, price_double) VALUES
I want an accomodation 
(2, 2, 95.00, 2, 150.00),
(3, 8, 110.00, 2, 170.00),
(4, 3, 130.00, 2, 200.00),
(5, 4, 105.00, 2, 160.00),
...
(8, 7, 115.00, 2, 175.00),
(9, 5, 125.00, 1, 185.00),
(10, 6, 140.00, 3, 210.00),
(11, 2, 240.00, 2, 300.00),
(12, 3, 40.00, 4, 60.00); 